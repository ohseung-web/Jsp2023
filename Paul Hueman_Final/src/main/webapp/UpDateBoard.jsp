...
<div id="boardlist">
		...
		<div id="list_main">
			...
			<div id="list_main_write">
				<form action="UpDateBoard.do" method="post" name="formname">
					<table>
						<tr>
							<th>상담유형</th>
							<td>
						...
						<tr>
							<th>제목</th>
							<td>
								<input type="text" name="b_subject" class="b_subject" value="${b_subject}">
							</td>
						</tr>
						<tr>
							<th>내용</th>
							<td>
								<textarea rows="5" cols="40" name="b_contents" class="b_contents">${b_contents}</textarea>
							</td>
						</tr>
					</table>
					<div id="last_button">
						<input type="hidden" value="${b_no }" name="b_no">
						<input type="button" id="sujung" onclick="Bnull();" value="수정">
