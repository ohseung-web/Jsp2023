...
.inquiryContainer .contents .typeList{
    border-top: 0;
}
table{
    width: 100%;
                ...
                <c:if test="${aList.size() ne 0}">
                    <div class="pageing">
                        <c:if test="${startPage>pageBlock }">
                            <a href="InquiryBoardList.do?pageNum=${startPage-pageBlock}">이전</a>
                        </c:if>
            
                        <ol>
                            <c:forEach var="i" begin="${startPage}" end="${endPage}">
                                <li>
                                    <a href="InquiryBoardList.do?pageNum=${i}">${i}</a>
                                </li>
                            </c:forEach>
                        </ol>
            
                        <c:if test="${endPage<pageCount}">
                            <a href="InquiryBoardList.do?pageNum=${startPage+pageBlock}">다음</a>
                        </c:if>
                    </div>
                </c:if>
            </div>
