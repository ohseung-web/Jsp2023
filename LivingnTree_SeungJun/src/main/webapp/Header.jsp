...
.headerContainer .headerContainerWrap .top_nav_box .top_mypage li #modalbtn{
   border : none;
...
<script>
    ...
    /*  let closebtn = document.querySelector("#closebtn");
     ...
     let modalbtn = document.querySelector(".headerContainer .headerContainerWrap .top_nav_box .top_mypage li #modalbtn");
