...
<body>
	<div class="reviewContainer">
        <div class="contents">
            ...
            <form id="boardUpdateForm" action="ReviewBoardUpdateProc.do" method="post">
                <div class="typeWrite">
                    <table>
                        <tr>
                            <th class="rw">제목</th>
                            <td>
                                <input type="text" name="subject" id="subject" value="${rdto.r_title}" maxlength="100">
                            </td>
                        </tr>
                        <tr>
                            <th class="rw top">본문</th>
                            <td>
                                <textarea name="content" id="content" width="100%" height="440" maxlength="500">${rdto.r_content}</textarea>
                            </td>
                        </tr>
                    </table>
